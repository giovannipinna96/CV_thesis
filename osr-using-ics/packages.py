...
#from keras.utils.np_utils import plot_model, to_categorical
#from tensorflow.python.keras.initializers import truncated_normal as tn
#from keras.backend.tensorflow_backend import set_session
from keras.backend import truncated_normal as tn
